...
#ifndef mozilla_dom_Rocketscience_Shared
#define mozilla_dom_Rocketscience_Shared
...
struct rocketscience_3a9e_RustBuffer {
  int32_t mCapacity;
  int32_t mLen;
  uint8_t* mData;
...
struct rocketscience_3a9e_ForeignBytes {
  int32_t mLen;
  const uint8_t* mData;
...
struct rocketscience_3a9e_RustError {
  int32_t mCode;
  char* mMessage;
};
...
void
ffi_rocketscience_3a9e_Rocket_object_free(
    uint64_t handle,
    rocketscience_3a9e_RustError* uniffi_out_err
);


uint64_t
rocketscience_3a9e_Rocket_new(
    rocketscience_3a9e_RustBuffer name,
    rocketscience_3a9e_RustError* uniffi_out_err
);


rocketscience_3a9e_RustBuffer
rocketscience_3a9e_Rocket_show(
    uint64_t handle,
    rocketscience_3a9e_RustError* uniffi_out_err
);
...
int8_t
rocketscience_3a9e_Rocket_launch(
    uint64_t handle,
    rocketscience_3a9e_RustError* uniffi_out_err
);
...
rocketscience_3a9e_Rocket_add(
    uint64_t handle,
    rocketscience_3a9e_RustBuffer part,
    rocketscience_3a9e_RustError* uniffi_out_err
);
...
rocketscience_3a9e_Rocket_lock_steering(
    uint64_t handle,
    rocketscience_3a9e_RustBuffer direction,
    rocketscience_3a9e_RustError* uniffi_out_err
);


rocketscience_3a9e_RustBuffer
ffi_rocketscience_3a9e_rustbuffer_alloc(
    int32_t size,
    rocketscience_3a9e_RustError* uniffi_out_err
);
...
rocketscience_3a9e_RustBuffer
ffi_rocketscience_3a9e_rustbuffer_from_bytes(
    rocketscience_3a9e_ForeignBytes bytes,
    rocketscience_3a9e_RustError* uniffi_out_err
);
...
void
ffi_rocketscience_3a9e_rustbuffer_free(
    rocketscience_3a9e_RustBuffer buf,
    rocketscience_3a9e_RustError* uniffi_out_err
);


rocketscience_3a9e_RustBuffer
ffi_rocketscience_3a9e_rustbuffer_reserve(
    rocketscience_3a9e_RustBuffer buf,
    int32_t additional,
    rocketscience_3a9e_RustError* uniffi_out_err
);
...
void
ffi_rocketscience_3a9e_string_free(
    const char* cstr,
    rocketscience_3a9e_RustError* uniffi_out_err
);
...
namespace rocketscience_detail {
...
class MOZ_STACK_CLASS Reader final {
 public:
  explicit Reader(const rocketscience_3a9e_RustBuffer& aBuffer) : mBuffer(aBuffer), mOffset(0) {}
 ...
 private:
  ...
  const rocketscience_3a9e_RustBuffer& mBuffer;
...
class MOZ_STACK_CLASS Writer final {
 public:
  Writer() {
    ...
    mBuffer = ffi_rocketscience_3a9e_rustbuffer_alloc(0, &err);
    if (err.mCode) {
  ...
  /// Returns the buffer.
  rocketscience_3a9e_RustBuffer Buffer() { return mBuffer; }
 ...
 private:
  ...
  void Reserve(size_t aBytes) {
    ...
    rocketscience_3a9e_RustError err = {0, nullptr};
    rocketscience_3a9e_RustBuffer newBuffer = ffi_rocketscience_3a9e_rustbuffer_reserve(
  ...
  rocketscience_3a9e_RustBuffer mBuffer;
};
...
template <>
struct ViaFfi<nsACString, rocketscience_3a9e_RustBuffer, false> {
  [[nodiscard]] static bool Lift(const rocketscience_3a9e_RustBuffer& aLowered,
                                 nsACString& aLifted) {
    if (aLowered.mData) {
      aLifted.Append(AsChars(Span(aLowered.mData, aLowered.mLen)));
      rocketscience_3a9e_RustError err = {0, nullptr};
      ffi_rocketscience_3a9e_rustbuffer_free(aLowered, &err);
      if (err.mCode) {
  ...
  [[nodiscard]] static rocketscience_3a9e_RustBuffer Lower(const nsACString& aLifted) {
    MOZ_RELEASE_ASSERT(
        aLifted.Length() <=
    ...
    rocketscience_3a9e_RustBuffer lowered = ffi_rocketscience_3a9e_rustbuffer_from_bytes(bytes, &err);
    if (err.mCode) {
...
template <>
struct ViaFfi<nsAString, rocketscience_3a9e_RustBuffer, false> {
  [[nodiscard]] static bool Lift(const rocketscience_3a9e_RustBuffer& aLowered,
                                 nsAString& aLifted) {
    if (aLowered.mData) {
  ...
  [[nodiscard]] static rocketscience_3a9e_RustBuffer Lower(const nsAString& aLifted) {
    ...
    rocketscience_3a9e_RustError err = {0, nullptr};
    rocketscience_3a9e_RustBuffer lowered = ffi_rocketscience_3a9e_rustbuffer_alloc(
...
template <typename T>
struct ViaFfi<T, rocketscience_3a9e_RustBuffer> {
  [[nodiscard]] static bool Lift(const rocketscience_3a9e_RustBuffer& aLowered, T& aLifted) {
  ...
  [[nodiscard]] static rocketscience_3a9e_RustBuffer Lower(const T& aLifted) {
    auto writer = Writer();
...
template <>
struct ViaFfi<nsACString, rocketscience_3a9e_RustBuffer, true> {
  [[nodiscard]] static bool Lift(const rocketscience_3a9e_RustBuffer& aLowered,
                                 nsACString& aLifted) {
    auto value = dom::Nullable<nsCString>();
    if (!ViaFfi<dom::Nullable<nsCString>, rocketscience_3a9e_RustBuffer>::Lift(aLowered, value)) {
      return false;
    }
    if (value.IsNull()) {
  ...
  [[nodiscard]] static rocketscience_3a9e_RustBuffer Lower(const nsACString& aLifted) {
    ...
    return ViaFfi<dom::Nullable<nsCString>, rocketscience_3a9e_RustBuffer>::Lower(value);
  }
};

template <>
struct ViaFfi<nsAString, rocketscience_3a9e_RustBuffer, true> {
  [[nodiscard]] static bool Lift(const rocketscience_3a9e_RustBuffer& aLowered,
                                 nsAString& aLifted) {
    auto value = dom::Nullable<nsString>();
    if (!ViaFfi<dom::Nullable<nsString>, rocketscience_3a9e_RustBuffer>::Lift(aLowered, value)) {
      return false;
    }
    if (value.IsNull()) {
      aLifted.SetIsVoid(true);
  ...
  [[nodiscard]] static rocketscience_3a9e_RustBuffer Lower(const nsAString& aLifted) {
    ...
    return ViaFfi<dom::Nullable<nsString>, rocketscience_3a9e_RustBuffer>::Lower(value);
  }
};
...
template <typename T>
struct ViaFfi<T, rocketscience_3a9e_RustBuffer, true> {
  [[nodiscard]] static bool Lift(const rocketscience_3a9e_RustBuffer& aLowered,
                                 T& aLifted) {
    auto reader = Reader(aLowered);
...
template <>
struct Serializable<Direction> {
  [[nodiscard]] static bool ReadFrom(Reader& aReader, Direction& aValue) {
  ...
  static void WriteInto(Writer& aWriter, const Direction& aValue) {
    switch (aValue) {
      case Direction::Up:
        aWriter.WriteInt32(1);
      case Direction::Down:
        aWriter.WriteInt32(2);
      default:
...
template <>
struct Serializable<Part> {
  [[nodiscard]] static bool ReadFrom(Reader& aReader, Part& aValue) {
    if (!Serializable<nsString>::ReadFrom(aReader, aValue.mName)) {
      return false;
    }
    if (!Serializable<uint64_t>::ReadFrom(aReader, aValue.mCost)) {
      return false;
    }
    if (!Serializable<uint64_t>::ReadFrom(aReader, aValue.mWeight)) {
      return false;
    }
    return true;
  }

  static void WriteInto(Writer& aWriter, const Part& aValue) {
    Serializable<nsString>::WriteInto(aWriter, aValue.mName);
    Serializable<uint64_t>::WriteInto(aWriter, aValue.mCost);
    Serializable<uint64_t>::WriteInto(aWriter, aValue.mWeight);
  }
};
...
#endif  // mozilla_dom_Rocketscience_Shared
...
def loadIndirect():
    ...
    lib = libname.format("rocketscience")
...
class FfiConverterTypeDirection(FfiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.readI32()
        if variant == 1:
...
class Rocket(object):
    def __init__(self, name):
        name = name
        self._pointer = rust_call(_UniFFILib.rocketscience_b310_Rocket_new,
    ...
    def show(self, ):
        return FfiConverterString.lift(
            rust_call(_UniFFILib.rocketscience_b310_Rocket_show,self._pointer,)
        )
    def launch(self, ):
        return FfiConverterBool.lift(
            rust_call_with_error(
    FfiConverterTypeLaunchError,_UniFFILib.rocketscience_b310_Rocket_launch,self._pointer,)
        )
    def add(self, part):
        part = part
        rust_call(_UniFFILib.rocketscience_b310_Rocket_add,self._pointer,
        FfiConverterTypePart.lower(part))
    
    def lock_steering(self, direction):
        direction = direction
        rust_call(_UniFFILib.rocketscience_b310_Rocket_lock_steering,self._pointer,
        FfiConverterTypeDirection.lower(direction))
    
    


class FfiConverterTypeRocket:
    @classmethod
    def read(cls, buf):
        ptr = buf.readU64()
        if ptr == 0:
...
class FfiConverterTypePart(FfiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return Part(
            name=FfiConverterString.read(buf),
            cost=FfiConverterUInt64.read(buf),
            weight=FfiConverterUInt64.read(buf),
        )

    @staticmethod
    def write(value, buf):
        FfiConverterString.write(value.name, buf)
        FfiConverterUInt64.write(value.cost, buf)
        FfiConverterUInt64.write(value.weight, buf)
...
class FfiConverterTypeLaunchError(FfiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.readI32()
        if variant == 1:
